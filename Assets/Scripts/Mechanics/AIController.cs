...
public class AIController : MonoBehaviour
{
    ...
    {
        // Calculate the rotation from the current rotation to the target rotation using Quaternion.Lerp
        Quaternion targetRotation = Quaternion.LookRotation(transform.position - targetTransform, Vector3.up);
