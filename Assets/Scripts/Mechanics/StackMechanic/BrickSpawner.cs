...
public class BrickSpawner : MonoBehaviour
{
    ...
    public GameObject brickSpawnArea;
    ...
    Vector3 randomizeSpawnPoint()
    {
        ...
        return new Vector3(Random.Range(meshBounds.min.x, meshBounds.max.x), meshBounds.max.y + 0.2f, Random.Range(meshBounds.min.z, meshBounds.max.z));
    }
}
